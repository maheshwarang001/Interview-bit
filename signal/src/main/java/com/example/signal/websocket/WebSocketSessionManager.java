...
public class WebSocketSessionManager {
    ...
    private final Map<String, Set<String>> map = new HashMap<>(); // room id and list of user ids
    ...
    public void addWebSocketSession(WebSocketSession webSocketSession, String roomID, String userID) {
        ...
        // Remove existing entry for the userID
        sessionMap.remove(userID);

        map.computeIfAbsent(roomID, k -> new HashSet<>()).add(userID);
    ...
    public void removeSocketSession(WebSocketSession webSocketSession, String roomID) {
        ...
        Set<String> usersInRoom = map.get(roomID);
        if (usersInRoom != null) {
    ...
    public List<WebSocketSession> getSessions(String roomID,String senderID) {
        ...
        Set<String> userIds = map.get(roomID);
        if (userIds != null) {
